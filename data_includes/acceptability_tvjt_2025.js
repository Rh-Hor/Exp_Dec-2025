...
[["second-item19-UE-all", 19], aj, {s: {html: "Kontext: Lorem Ipsum <div style=\"text-align:center;\"><img style=\"display:block;max-width:400px;max-height:300px;width:auto;height:auto;margin:0 auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/1-all.png?raw=true\"></div><center>Boris se dívá na boxy a říká:</p> 1. <i>Všechny trojúhelníky jsou v levém boxu.</i></p></p>Z Borisova pozorování plyne, že:<p> 2. <i>všechny červené trojúhelníky jsou v levém boxu.</i></p> </center>"}, as: ["Pravdivost Borisovy první věty zaručuje pravdivost druhé věty", "Pravdivost Borisovy první věty nezaručuje pravdivost druhé věty."], presentAsScale: false, leftComment: null, rightComment: null}],

[["second-item19-UE-most", 19], aj, {s: {html: "Kontext: Lorem Ipsum <div style=\"text-align:center;\"><img style=\"display:block;max-width:700px;max-height:300px;width:auto;height:auto;margin:0 auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/1-most.png?raw=true\"></div><center>Boris se dívá na boxy a říká:</p> 1. <i>Většina trojúhelníků je v levém boxu.</i></p></p>Z Borisova pozorování plyne, že: <p> 2. <i>Většina XXX. </i></p> </center>"}, as: ["Pravdivost Borisovy první věty zaručuje pravdivost druhé věty", "Pravdivost Borisovy první věty nezaručuje pravdivost druhé věty."], presentAsScale: false, leftComment: null, rightComment: null}],

[["second-item19-UE-some", 19], aj, {s: {html: "Kontext: Lorem Ipsum <div style=\"text-align:center;\"><img style=\"display:block;max-width:400px;max-height:300px;width:auto;height:auto;margin:0 auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/1-some.png?raw=true\"></div><center>Boris se dívá na boxy a říká:</p> 1. <i>Některé trojúhelníky jsou v levém boxu.</i></p></p>Z Borisova pozorování plyne, že: <p> 3.<i> Některé XXX</i></p></center>"}, as: ["Pravdivost Borisovy první věty zaručuje pravdivost druhé věty", "Pravdivost Borisovy první věty nezaručuje pravdivost druhé věty."], presentAsScale: false, leftComment: null, rightComment: null}],

["second-filler1-bad", aj, {s: {html: "Kontext: Lorem Ipsum<div style=\"text-align:center;\"><img style=\"display:block;max-width:400px;max-height:300px;width:auto;height:auto;margin:0 auto;\" src=\"https://github.com/Rh-Hor/Exp_Dec-2025/blob/main/1-mixed.png?raw=true\"></div><center>Boris se dívá na boxy a říká: <i>Každý fotograf vyfotil obě modelky.</i></p></p>Z Borisova pozorování plyne, že</center>"}, as: ["Pravdivost Borisovy první věty zaručuje pravdivost druhé věty", "Pravdivost Borisovy první věty nezaručuje pravdivost druhé věty."], presentAsScale: false, leftComment: null, rightComment: null}],  
